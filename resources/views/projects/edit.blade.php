    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('projects.update', $project->id) }}" method="POST" x-data="projectForm()">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="employee_id" class="form-control" id="employee_id" required>
                            @foreach($employees as $employee)
                                <option value="{{ $employee->id }}" {{ $project->employee_id == $employee->id ? 'selected' : '' }}>{{ $employee->fullname }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <script>
                    function projectForm() {
                        return {
                            ...
                            details: @json($project->projectDetails->map(function($detail) {
                                return [
